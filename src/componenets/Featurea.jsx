    ...
    <section className="packages">
      ...
      <div className="packages-container">
        <div className="package-card">
          <span className="badgea">Basic</span>
          ...
          <ul>
            ...
            <button className="btna white-btn">
              See Details <img src={arrow} />
            </button>
        </div>

        <div className="package-card popular">
          <span className="badgea white">Popular</span>
          ...
          <div className="btn-prt">
            <button className="btna white-btn newtnn">
              See Details <img src={arrow} />
            </button>
          </div>
        </div>
        ...
        <div className="package-card">
          <span className="badgea">Premium</span>
